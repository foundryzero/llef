...
class SBAddress:
    ...
    def __ne__(self, rhs: Incomplete) -> bool: ...
...
class SBAddressRange:
    ...
    def __eq__(self, rhs: Incomplete) -> bool: ...
    def __ne__(self, rhs: Incomplete) -> bool: ...
...
class SBAddressRangeList:
    ...
    def Append(self, addr_range: SBAddressRange | SBAddressRangeList) -> None: ...
    def GetDescription(self, description: SBStream, target: SBTarget) -> bool: ...
...
class SBAttachInfo:
    ...
    def SetExecutable(self, arg: str | SBFileSpec) -> None: ...
    def GetWaitForLaunch(self) -> bool: ...
    def SetWaitForLaunch(self, b: bool, _async: bool | None) -> None: ...
...
class SBBlock:
    ...
    __bool__ = __nonzero__
    def IsValid(self) -> bool: ...
    def GetInlinedName(self) -> str | None: ...
    ...
    def GetVariables(
        self,
        frm_or_tgt: SBFrame | SBTarget,
        args: bool,
        locs: bool,
        stats: bool,
        use_dynamic: Incomplete | None,
    ) -> SBValueList: ...
...
class SBBreakpoint:
    ...
    def SetScriptCallbackFunction(
        self, callback_function_name: str, extra_args: SBStructuredData | None
    ) -> SBError | None: ...
...
class SBCommandInterpreter:
    ...
    def SourceInitFileInHomeDirectory(self, result: SBCommandReturnObject, is_repl: bool | None) -> None: ...
...
class SBSaveCoreOptions:
    ...
    def __init__(self, *args: Incomplete) -> None: ...
    __swig_destroy__: Incomplete
    def SetPluginName(self, plugin: str | None) -> SBError: ...
    def GetPluginName(self) -> str | None: ...
    def SetStyle(self, style: int) -> None: ...
    def GetStyle(self) -> int: ...
    def SetOutputFile(self, output_file: SBFileSpec) -> None: ...
    def GetOutputFile(self) -> SBFileSpec | None: ...
...
class SBData:
    ...
    def ReadRawData(self, error: SBError, offset: int, buf: Incomplete) -> int: ...
    def GetDescription(self, description: SBStream, base_addr: int | None) -> bool: ...
    ...
    @staticmethod
    def CreateDataFromUInt64Array(endian: int, addr_byte_size: int, array: list[int | bool]) -> SBData: ...
    @staticmethod
    def CreateDataFromUInt32Array(endian: int, addr_byte_size: int, array: list[int | bool]) -> SBData: ...
    @staticmethod
    def CreateDataFromSInt64Array(endian: int, addr_byte_size: int, array: list[int | bool]) -> SBData: ...
    @staticmethod
    def CreateDataFromSInt32Array(endian: int, addr_byte_size: int, array: list[int | bool]) -> SBData: ...
    @staticmethod
...
class SBDebugger:
    ...
    def IsValid(self) -> bool: ...
    def Clear(self) -> None: ...
    def GetSetting(self, setting: str | None = None) -> SBStructuredData: ...
    ...
    def CreateTarget(
        ...
        add_dependent_modules: bool | None,
        error: SBError | None,
    ) -> SBTarget: ...
...
class SBFrame:
    ...
    def FindVariable(self, name: str, use_dynamic: int | None) -> SBValue: ...
    def GetValueForVariablePath(self, var: str, use_dynamic: int | None) -> SBValue: ...
    def FindValue(self, name: str, value_type: int, use_dynamic: int | None) -> SBValue: ...
    def GetDescription(self, description: SBStream) -> bool: ...
...
class SBFunction:
    ...
    def GetInstructions(self, target: SBTarget, flavor: str | None) -> SBInstructionList: ...
...
class SBInstructionList:
    ...
    def Print(self, out: Incomplete) -> None: ...
    def GetDescription(self, description: SBStream, exe_ctx: SBExecutionContext | None) -> bool: ...
...
class SBMemoryRegionInfoList:
    ...
    def Append(self, reg: SBMemoryRegionInfo | SBMemoryRegionInfoList) -> None: ...
    def Clear(self) -> None: ...
    def __len__(self) -> int: ...
    def __iter__(self) -> Incomplete: ...
...
class SBModule:
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> Incomplete: ...
    def section_iter(self) -> Incomplete: ...
    def compile_unit_iter(self) -> Incomplete: ...
    def symbol_in_section_iter(self, section: Incomplete) -> Iterator[Incomplete]: ...
...
class SBModuleSpecList:
    ...
    def Append(self, spec: SBModuleSpec | SBModuleSpecList) -> None: ...
...
class SBProcess:
    ...
    def Detach(self, keep_stopped: bool | None) -> SBError: ...
    ...
    def ReadMemory(self, addr: int, len: int, error: SBError) -> bytes | None: ...
    ...
    def GetAddressMask(self, type: int, addr_range: int | None) -> int: ...
    def SetAddressMask(self, type: int, mask: int, addr_range: int | None) -> None: ...
    ...
    def GetScriptedImplementation(self) -> SBScriptObject | None: ...
...
class SBProgress:
    ...
    def __init__(self, *args: Incomplete) -> None: ...
    __swig_destroy__: Incomplete
    def Increment(self, amount: int, description: str | None = None) -> None: ...
...
class SBSection:
    ...
    def GetSectionData(self, offset: int | None, size: int | None) -> SBData: ...
...
class SBStringList:
    ...
    def GetSize(self) -> int: ...
    def GetStringAtIndex(self, idx: int) -> Incomplete: ...
    def Clear(self) -> None: ...
    def __iter__(self) -> Incomplete: ...
    def __len__(self) -> int: ...
...
class SBStructuredData:
    ...
    __bool__ = __nonzero__
    def IsValid(self) -> bool: ...
    def SetFromJSON(self, json: str | SBStream) -> SBError: ...
    def Clear(self) -> None: ...
...
class SBSymbol:
    ...
    def GetDisplayName(self) -> str: ...
    def GetMangledName(self) -> str: ...
    def GetInstructions(self, target: SBTarget, flavor_string: str | None) -> SBInstructionList: ...
    def GetStartAddress(self) -> SBAddress: ...
    def GetEndAddress(self) -> SBAddress: ...
...
class SBSymbolContextList:
    ...
    def GetDescription(self, description: SBStream) -> bool: ...
    def Append(self, sc: SBSymbolContext | SBSymbolContextList) -> None: ...
    def Clear(self) -> None: ...
    def __iter__(self) -> Incomplete: ...
    def __len__(self) -> int: ...
    def __getitem__(self, key: Incomplete) -> Incomplete: ...
...
class SBTarget:
    ...
    def GetStatistics(self, options: SBStatisticsOptions | None) -> SBStructuredData: ...
    def ResetStatistics(self) -> None: ...
    def GetPlatform(self) -> SBPlatform: ...
    def GetEnvironment(self) -> SBEnvironment: ...
    def Install(self) -> SBError: ...
    def LoadCore(self, core_file: str, error: SBError | None) -> SBProcess: ...
    ...
    def ResolveSymbolContextForAddress(self, addr: SBAddress, resolve_scope: int) -> SBSymbolContext: ...
    def ReadMemory(self, addr: SBAddress, num: int, error: SBError) -> bytes | None: ...
    ...
    def EvaluateExpression(self, expr: str, options: SBExpressionOptions | None = None) -> SBValue: ...
...
class SBThread:
    ...
    def StepOver(self, stop_other_threads: int, error: SBError | None) -> None: ...
    def StepInto(self, *args: Incomplete) -> None: ...
    def StepOut(self, error: SBError | None) -> None: ...
    def StepOutOfFrame(self, frame: SBFrame, error: SBError | None) -> None: ...
    def StepInstruction(self, step_over: bool, error: SBError | None) -> None: ...
    ...
    def RunToAddress(self, addr: int, error: SBError | None) -> None: ...
    ...
    def __eq__(self, rhs: Incomplete) -> bool: ...
    def __ne__(self, rhs: Incomplete) -> bool: ...
    def GetDescription(self, desc: SBStream, stop_format: bool | None) -> bool: ...
    def GetDescriptionWithFormat(self, format: SBFormat, output: SBStream) -> SBError: ...
...
class SBThreadPlan:
    ...
    def QueueThreadPlanForStepOverRange(
        self, start_address: SBAddress, range_size: int, error: SBError | None
    ) -> SBThreadPlan: ...
    def QueueThreadPlanForStepInRange(
        self, start_address: SBAddress, range_size: int, error: SBError | None
    ) -> SBThreadPlan: ...
    def QueueThreadPlanForStepOut(
        self, frame_idx_to_step_to: int, first_insn: bool, error: SBError | None
    ) -> SBThreadPlan: ...
    def QueueThreadPlanForRunToAddress(self, address: SBAddress, error: SBError | None) -> SBThreadPlan: ...
...
class SBType:
    ...
    def GetBasicType(self, type: int | None) -> int | SBType: ...
...
class SBValue:
    ...
    def GetSummary(self, stream: SBStream | None, options: SBTypeSummaryOptions | None) -> Incomplete: ...
    ...
    def CreateValueFromExpression(self, name: str, expression: str, options: SBExpressionOptions | None) -> SBValue: ...
    ...
    def GetChildAtIndex(self, idx: int, use_dynamic: int | None, treat_as_array: bool | None) -> SBValue: ...
    ...
    def Watch(self, resolve_loc: bool, read: bool, write: bool, error: SBError | None) -> SBWatchpoint: ...
    ...
    def get_value_child_list(self) -> list[Incomplete]: ...
    def __hex__(self) -> Incomplete: ...
    def __iter__(self) -> Incomplete: ...
    def __len__(self) -> int: ...
...
class SBValueList:
    ...
    def IsValid(self) -> bool: ...
    def Clear(self) -> None: ...
    def Append(self, val: SBValue | SBValueList) -> None: ...
    def GetSize(self) -> int: ...
